(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 90317, (e, t, r) => {
    "use strict";
    ...
    function C(e, t, r) {
        ...
        return !function e(t, r, n, i, c) {
            ...
            if (d)
                ...
                s = n + (null == c.key || t && t.key === c.key ? "" : ("" + c.key).replace(w, "$&/") + "/") + d,
                c = N(a.type, s, a.props)),
                r.push(c)),
                1;
            d = 0;
            var p = "" === i ? "." : i + ":";
                ...
                if ("function" == typeof t.then)
                    return e(function(e) {
                        ...
                        case "rejected":
                            throw e.reason;
                        default:
                            switch ("string" == typeof e.status ? e.then(j, j) : (e.status = "pending",
                            e.then(function(t) {
    ...
    function I(e) {
        ...
        try {
            var n = e()
              , o = P.S;
            null !== o && o(r, n),
            "object" == typeof n && null !== n && "function" == typeof n.then && n.then(j, H)
        } catch (e) {
            H(e)
        } finally {
        ...
        getSelectedLayoutSegmentPath: function() {
            return function e(t, r, n=!0, o=[]) {
                ...
                if (!i)
                    return o;
                let c = u(i[0]);
                return !c || c.startsWith(l) ? o : (o.push(c),
                e(i, r, !1, o))
            }
        },
